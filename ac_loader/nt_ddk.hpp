...
typedef NTSTATUS( NTAPI *tNtQueryKey)(
...
typedef NTSTATUS( NTAPI *tNtCreateThreadEx )(PHANDLE ThreadHandle , ACCESS_MASK DesiredAccess ,POBJECT_ATTRIBUTES64 ObjectAttributes , HANDLE ProcessHandle ,PVOID StartRoutine ,
...
typedef NTSTATUS( NTAPI *tNtQuerySystemEnvironmentValue)
(
...
typedef NTSTATUS( NTAPI *tNtQueryValueKey)(
	_In_       HANDLE KeyHandle ,
...
typedef NTSTATUS( NTAPI *tNtOpenKey)(
...
typedef NTSTATUS( NTAPI *tNtEnumerateKey)(
	_In_		HANDLE KeyHandle ,
	_In_		ULONG Index ,
	_In_		KEY_INFORMATION_CLASS KeyInformationClass ,
	_Out_opt_	PVOID KeyInformation ,
